...
import {
  ...
  IMU_gyro_range,
  IMU_Gyro_Settings,
  IMU_SensorConfig, IMUPacket,
  LuxPacket, MicLevelPacket,
  MicPacket,
  MicSensorConfig,
  SGPPacket,
  Sht45_heater,
...
import { SensorConfig_Type, SensorPacket_Payload, SensorType, to_packet_type } from './types';
  ...
  switch (type.replace(/Packet$/, '')) {
    ...
    case 'bme':
      ...
      return bme_packet.payload.
        ...
        filter(({ name }) => !/^RAW_/.test(name) && !/_STATUS$/.test(name));
